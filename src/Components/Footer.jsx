    ...
    <div className='footer'>
      ...
      <div className='footer-container'>
        ...
        <div className='Navigation-links'>
          <h1>NAVIGATION</h1>
          <Link to='/Stoxy'><p>Home</p></Link>
          <Link to='/Shop/All'><p>Shop</p></Link>
          <Link to='/About'><p>About</p></Link>
          <Link to='/Contact'><p>Contact</p></Link>
        </div>
        <div className='Categories-links'>
          <h1>Categories</h1>
          <Link to='/Shop/Clothes'><p>Clothes</p></Link>
          <Link to="/Shop/Shoes"><p>Shoes</p></Link>
          <Link to="/Shop/Electronics"><p>Electronics</p></Link>
          <Link to="/Shop/Furniture"><p>Fourniture</p></Link>
          <Link to="/Shop/Miscellaneous"><p>Miscellaneous</p></Link>
        </div>
